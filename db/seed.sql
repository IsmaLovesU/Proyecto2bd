...
('Laptop HP 15"',        'Procesador i5, 8GB RAM, 512GB SSD',         3500.00, 15, '/img/image.png', 1, 1),
('Mouse inalámbrico',    'USB, 3 botones, alcance 10m',                 150.00, 50, '/img/image.png', 1, 1),
('Teclado mecánico',     'Switch blue, retroiluminado RGB',              450.00, 30, '/img/image.png', 1, 1),
('Audífonos Bluetooth',  'Cancelación de ruido, 30h batería',            850.00, 25, '/img/image.png', 1, 1),
('Cargador USB-C 65W',   'Carga rápida, compatible multi-dispositivo',   120.00, 60, '/img/image.png', 1, 1),
('Crema hidratante',     'Con vitamina E, 200ml, todo tipo de piel',      85.00, 40, '/img/image.png', 2, 2),
('Sérum vitamina C',     'Antioxidante, 30ml, uso diario',               220.00, 35, '/img/image.png', 2, 2),
('Shampoo nutritivo',    'Con keratina, 400ml, cabello seco',             95.00, 45, '/img/image.png', 2, 2),
('Set de brochas',       '12 piezas, pelo sintético, estuche incluido',  180.00, 20, '/img/image.png', 2, 2),
('Perfume floral 50ml',  'Notas de jazmín y rosa, larga duración',       350.00, 18, '/img/image.png', 2, 2),
('Balón de fútbol',      'Talla 5, cuero sintético, uso exterior',       150.00, 25, '/img/image.png', 3, 3),
('Guantes de box',       '12oz, cuero genuino, par',                     280.00, 20, '/img/image.png', 3, 3),
('Cuerda para saltar',   'Acero trenzado, ajustable, rodamientos',        75.00, 40, '/img/image.png', 3, 3),
('Botella deportiva',    '1 litro, acero inoxidable, térmica',           120.00, 50, '/img/image.png', 3, 3),
('Rodilleras x2',        'Neopreno, talla única, soporte reforzado',      90.00, 30, '/img/image.png', 3, 3),
('Florero de vidrio',    'Transparente, 30cm alto, diseño moderno',       60.00, 15, '/img/image.png', 4, 4),
('Marco de fotos 4x6',   'Madera natural, acabado mate',                  45.00, 30, '/img/image.png', 4, 4),
('Velas aromáticas x3',  'Lavanda, vainilla y canela, 40h cada una',    110.00, 25, '/img/image.png', 4, 4),
('Cactus artificial',    'Maceta cerámica, 25cm, sin mantenimiento',      80.00, 20, '/img/image.png', 4, 4),
('Reloj de pared',       'Madera, 30cm diámetro, silencioso',            195.00, 12, '/img/image.png', 4, 4),
('Sartén antiadherente', '28cm, libre de PFOA, mango ergonómico',       120.00, 20, '/img/image.png', 5, 5),
('Licuadora 600W',       '3 velocidades, vaso vidrio 1.5L',              320.00, 18, '/img/image.png', 5, 5),
('Set cuchillos x5',     'Acero inoxidable, bloque incluido',            275.00, 15, '/img/image.png', 5, 5),
('Tazas x4 cerámica',    '350ml, aptas microondas y lavavajillas',        98.00, 30, '/img/image.png', 5, 5),
('Tabla de corte bambú', '40x25cm, antideslizante, antibacterial',        85.00, 25, '/img/image.png', 5, 5);
